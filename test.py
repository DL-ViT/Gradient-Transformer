...
parser.add_argument("--model_names", default=['GTransformerv4'], type=str, nargs='+',
...
parser.add_argument("--test_epo", type=str, default='298', help="Number of epoch for test")
...
def test():
    ...
    param_path = "log5/" + opt.dataset_name + "/" + opt.model_name+'_save' + '/' + opt.test_epo + '.pth.tar'
